...
*   [Programming](#GatewayArduinomanual-Programming)
    *   [Protocol](#GatewayArduinomanual-Protocol)
        *   [Modbus](#GatewayArduinomanual-Modbus)
        *   [MQTT](#GatewayArduinomanual-MQTT)
        *   [UDP](#GatewayArduinomanual-UDP)
            *   [Inputs](#GatewayArduinomanual-Inputs)
            *   [Ouputs](#GatewayArduinomanual-Ouputs)
            *   [Analog outputs](#GatewayArduinomanual-Analogoutputs)
        *   [Inputs](#GatewayArduinomanual-Inputs.1)
        *   [Button](#GatewayArduinomanual-Button)
            *   [Modbus Readout](#GatewayArduinomanual-ModbusReadout)
            *   [MQTT Readout](#GatewayArduinomanual-MQTTReadout)
        *   [Sensor](#GatewayArduinomanual-Sensor)
            *   [Modbus Readout](#GatewayArduinomanual-ModbusReadout.1)
            *   [MQTT Readout](#GatewayArduinomanual-MQTTReadout.1)
    *   [Outputs](#GatewayArduinomanual-Outputs)
        *   [Relay](#GatewayArduinomanual-Relay)
            *   [Modbus Control](#GatewayArduinomanual-ModbusControl)
            *   [MQTT Control](#GatewayArduinomanual-MQTTControl)
        *   [Blind](#GatewayArduinomanual-Blind)
            *   [Modbus Control](#GatewayArduinomanual-ModbusControl.1)
            *   [MQTT Control](#GatewayArduinomanual-MQTTControl.1)
    *   [Analog Outputs](#GatewayArduinomanual-AnalogOutputs)
        *   [Dimmer](#GatewayArduinomanual-Dimmer)
